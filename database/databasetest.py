...
print "[0] Esci"
print
select = input("Selezionare numero: ")
if select == 1:
	print
	del raw_input
	print
	time.sleep(1)
	name = raw_input("Cliente: ")
	app = raw_input("Applicazione: ")
	number = raw_input("Password: ")
...
if select == 2:
    print
    del raw_input
    research = raw_input("Cliente da cercare: ")
    print
    ...
    for line in searchfile:
        if research in line:
        	print line
    		print
    		back = raw_input("Premere un tasto per continuare ")
    		subprocess.call("clear", shell=True)
if select == 3:
    del raw_input
    print
    client = raw_input("Cliente da eliminare: ")
    delete = "sed -i '/%s/d' db"
...
if select == 9:
    ...
    print "|                                                    |"
    print "| Contatti:                                          |"
    print "| Sito: http://alexis82.it                           |"
    print "| E-Mail: giobbia82@gmail.com                        |"
    print "|----------------------------------------------------|"
    print
    raw_input("Premere un tasto per uscire")
    subprocess.call("clear", shell=True)
    subprocess.call("python2 databasetest.py", shell=True)
if select == 0:
	subprocess.call("clear", shell=True)
